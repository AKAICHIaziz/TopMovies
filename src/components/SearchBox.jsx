...
export default function SearchBox() {
    ...
    return (
        <form className="flex justify-between px-5 max-w-6xl mx-auto" onSubmit={handleSubmit}>
            ...
            <button className="text-white font-bold disabled:text-gray-400 disabled:bg-transparent bg-black pl-3 pr-3 mt-2 h-10 rounded-md" disabled={search === ''}>Search</button>
        </form>
    ) 
}
